...
> **状态**：设计定案，**未实现**（**P2**，见 `DOC/devNotes/04-TODO.md`）。  
> **定案日期**：2026-06-10  
> **关联**：`DOC/devNotes/03` §12（角色卡）、§13（资料库 / Lorebook）、§6.6（组装槽位）；`DOC/devNotes/26`（ST 迁移）；[Tavern Card V2 — character_book](https://github.com/malfoyslastname/character-card-spec-v2/blob/main/spec_v2.md)。
...
会话 lore（`DOC/devNotes/04` P0）已按上表拆桶；内嵌书 Phase 1 应**并入同一对 ctx 字段**，勿再单独硬编码 `embeddedLoreBeforeChar`。
