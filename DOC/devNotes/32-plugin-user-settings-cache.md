...
> **关联**：`DOC/devNotes/04` P0、`DOC/devNotes/18` §3.10、`DOC/devNotes/21`（会话 settings 已落地模式）、`DOC/devNotes/30` trace-keeper 侧栏 refresh、`DOC/devNotes/11` §6 Web 宿主清单  
...
- [x] `web/src/plugins/types.ts` + `DOC/devNotes/18` §3.10：文档化 snapshot API
