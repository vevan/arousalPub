...
> **关联**：`DOC/devNotes/04` P0、`DOC/devNotes/31` §6.3、`DOC/devNotes/03` §11.2、`web/src/App.vue`、`web/src/style.css`  
...
详见 `DOC/devNotes/03` §6.8「落盘与客户端连接解耦」。
...
| `DOC/devNotes/31-main-layout-plugin-rails.md` | 桌面三列 + §6.3 窄屏 |
...
| 2026-06-25 | iOS 友测：软键盘 / 底部空白；分析记入 §6、`DOC/devNotes/04` P0 |
