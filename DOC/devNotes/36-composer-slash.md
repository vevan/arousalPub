...
> **定案**：群聊 `/@` 语义见 [`DOC/devNotes/35`](35-group-chat.md) §2.3  
> **待办**：无；里程碑见 [`DOC/devNotes/04`](04-TODO.md) **§已归档**
...
- 群聊 `speakerQueue` / G1：[`DOC/devNotes/35`](35-group-chat.md)  
- 对话 Composer 壳层：[`DOC/devNotes/03`](03-实现细节.md) §11.2、§11.5
