...
> **索引**：[`DOC/devNotes/04`](04-TODO.md) §Sandbox「相关（与 Sandbox 交叉）」  
> **关联**：[`DOC/devNotes/38`](38-plugin-sandbox-and-host-evolution.md) §5 · [`DOC/devNotes/03`](03-实现细节.md) §1.2–§1.3 · [`DOC/devNotes/18`](18-plugin-host-developer-api.md) · [`DOC/devNotes/21`](21-conversation-plugin-settings.md) · [`DOC/devNotes/10`](10-plugin-conversation-host.md) §7 · [`DOC/devNotes/24`](24-regex-and-session-audit.md) §3.6
...
- **C2** 沙箱运维 — 见 [`DOC/devNotes/38`](38-plugin-sandbox-and-host-evolution.md) §5 Phase B
...
见 §4 B1；[`DOC/devNotes/24`](24-regex-and-session-audit.md) §3.6。
...
| `ctx.patchTurns` | 按 DOC/devNotes/10 §7 字段级：`turn.send.write` · `turn.receive.content.write` · `turn.receive.reasoning.write` · `turn.receive.prune` |
...
- [x] 审计三分法 · audit gate · plot-summary dryRun 预览 · DOC/devNotes/24 §3.6
...
- [x] **B4.3** `patchTurns` 按 DOC/devNotes/10 §7 字段级校验（对比 patch 前 turn 快照）
