...
> **关联**：[`DOC/devNotes/35`](35-group-chat.md) §2.1 · [`DOC/devNotes/04`](04-TODO.md) §TK-D · [`DOC/devNotes/03`](03-实现细节.md) §6.8
...
- TK-H Host 快照 / 写回直接基于 `segments[]`（见 [`DOC/devNotes/30`](30-plugin-trace-keeper.md) · [`DOC/devNotes/04`](04-TODO.md) §已归档）
