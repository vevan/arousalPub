...
上一章：[10 · 设置页导览](10-settings-tour.md) · 下一章：[12 · 数据在哪、怎么备份](12-data-and-backup.md) · [目录](00-menu.md) · [English](../EN/11-vector-recall.md)
...
| **知识库 RAG** | 独立文档知识库的召回与切片参数（文档先在 [09 · 资产库](09-files-and-assets.md) 上传并加入知识库） |
...
下一步（按需）：[12 · 数据在哪、怎么备份](12-data-and-backup.md)。
