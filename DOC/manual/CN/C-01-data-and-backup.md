...
上一章：[B-07 · 向量召回](B-07-vector-recall.md) · 下一章：[C-02 · 用 Docker 跑](C-02-docker.md) · [目录](00-menu.md) · [English](../EN/C-01-data-and-backup.md)
...
1. 在新机器装好并跑通程序（[A-01](A-01-install-and-start.md)）。
...
下一步（按需）：[C-02 · 用 Docker 跑](C-02-docker.md)。
