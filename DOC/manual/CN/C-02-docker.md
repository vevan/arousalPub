...
上一章：[C-01 · 数据在哪、怎么备份](C-01-data-and-backup.md) · 下一章：[C-03 · 启动方式对照与倒计时](C-03-startup-options.md) · [目录](00-menu.md) · [English](../EN/C-02-docker.md)
...
默认把项目内 **`./data`** 挂到容器 **`/data`**，与本地 `!_start` 使用同一套目录布局，便于备份（[C-01](C-01-data-and-backup.md)）。
...
下一步：[C-03 · 启动方式对照与倒计时](C-03-startup-options.md)。
