# 02 · First login and account

After this chapter: you have a working account, can reach the main UI, and understand **default user**.

Prev: [01 · Install and start](01-install-and-start.md) · Next: [03 · Connect the API](03-connect-api.md) · [Menu](00-menu.md) · [中文](../CN/02-first-login.md)
...
Next: configure the model — [03 · Connect the API](03-connect-api.md).
