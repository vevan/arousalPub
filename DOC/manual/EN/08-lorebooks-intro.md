...
Prev: [07 · Prompt presets intro](07-prompts-intro.md) · Next: [09 · Settings tour](09-settings-tour.md) · [Menu](00-menu.md) · [中文](../CN/08-lorebooks-intro.md)
...
- **Constant injection**
- **Keyword trigger**
- **Vector trigger** (needs Embeddings; see [10](10-vector-recall.md))
...
ST world-info migration: [16](16-from-sillytavern.md).
...
Lorebook **vector TopK** and similar live under **Settings → Vector recall** ([10](10-vector-recall.md)).
...
Next: [09 · Settings tour](09-settings-tour.md).
