...
Prev: [08 · Lorebooks (world info) intro](08-lorebooks-intro.md) · Next: [10 · Settings tour](10-settings-tour.md) · [Menu](00-menu.md) · [中文](../CN/09-files-and-assets.md)
...
| **Knowledge bases** | Group uploaded **documents** for chunking and vector recall (needs Embeddings; see [11](11-vector-recall.md)) |
...
Global Embeddings and knowledge RAG toggles live under **Settings → Vector recall** ([11 · Vector recall](11-vector-recall.md)). Without Embeddings you can still manage files; document recall will not work.
...
| **Lorebooks** | World info ([08](08-lorebooks-intro.md)), not via the asset library |
...
Next: [10 · Settings tour](10-settings-tour.md).
