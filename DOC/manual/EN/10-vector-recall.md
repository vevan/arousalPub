...
Prev: [09 · Settings tour](09-settings-tour.md) · Next: [11 · Where data lives and how to back up](11-data-and-backup.md) · [Menu](00-menu.md) · [中文](../CN/10-vector-recall.md)
...
| **Knowledge RAG** | Independent document KB recall and chunk settings |
...
Next (as needed): [11 · Where data lives and how to back up](11-data-and-backup.md).
