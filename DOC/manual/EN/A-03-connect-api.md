...
Prev: [A-02 · First login and account](A-02-first-login.md) · Next: [A-04 · Character cards: import or create](A-04-characters.md) · [Menu](00-menu.md) · [中文](../CN/A-03-connect-api.md)
...
**Embeddings** (vectors / long-term memory) live under **Settings → Vector recall**, separate from this chapter; see [B-07 · Vector recall](B-07-vector-recall.md) when needed.
...
Next: [A-04 · Character cards: import or create](A-04-characters.md).
