# C-01 · Where data lives and how to back up
...
Prev: [B-07 · Vector recall](B-07-vector-recall.md) · Next: [C-02 · Run with Docker](C-02-docker.md) · [Menu](00-menu.md) · [中文](../CN/C-01-data-and-backup.md)
...
1. Install and run the app on the new machine ([A-01](A-01-install-and-start.md)).
...
Next (as needed): [C-02 · Run with Docker](C-02-docker.md).
