...
Prev: [C-01 · Where data lives and how to back up](C-01-data-and-backup.md) · Next: [C-03 · Startup options and countdown](C-03-startup-options.md) · [Menu](00-menu.md) · [中文](../CN/C-02-docker.md)
...
By default project **`./data`** mounts to container **`/data`**, same layout as local `!_start` — easy to back up ([C-01](C-01-data-and-backup.md)).
...
Next: [C-03 · Startup options and countdown](C-03-startup-options.md).
