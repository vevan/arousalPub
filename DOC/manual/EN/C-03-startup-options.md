# C-03 · Startup options and countdown
...
Prev: [C-02 · Run with Docker](C-02-docker.md) · Next: [D-01 · Group chat and branches intro](D-01-group-and-branches.md) · [Menu](00-menu.md) · [中文](../CN/C-03-startup-options.md)
...
Optional advanced: [D-01 · Group chat and branches intro](D-01-group-and-branches.md).
