...
Prev: [D-03 · Migrating from SillyTavern](D-03-from-sillytavern.md) · Next: [D-05 · Bundled plugins guide](D-05-bundled-plugins.md) · [Menu](00-menu.md) · [中文](../CN/D-04-session-debug-audit.md)
...
| **Performance** | Assembly, memory, lore, **outgoing/persist regex**, upstream TTFB/first token/TPS, persist timings |

Empty tabs usually mean that turn had no data for that section, or the turn predates audit.

To verify **outgoing** regex against what the model saw: use the **Messages** tab (already post-outgoing). Rule setup: [B-06 · Regex rules intro](B-06-regex-rules.md).
...
Next: [D-05 · Bundled plugins guide](D-05-bundled-plugins.md).
