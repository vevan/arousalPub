...
async function exportConversation(host, range, regexRuleIds) {
  ...
  if (maxOrd < 0 || rangeFrom > rangeTo) {
    host.ui.notify(host.t(k("notifyEmpty")), void 0, { level: "info" });
    return;
  }
  ...
  try {
    ...
    host.ui.notify(host.t(k("notifyDone")), void 0, { level: "success" });
  } catch (e) {
    const msg = e instanceof Error ? e.message : String(e);
    host.ui.notify(`${host.t(k("notifyFailed"))}: ${msg}`, void 0, { level: "error" });
  } finally {
