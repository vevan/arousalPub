...
import {
  ...
  type GroupChatDiceSkipReason,
  type GroupChatMemberSettings,
  type GroupChatMode,
...
export function segmentSkipQuotaDeductionOnRecord(seg: AssistantSegmentRecord): boolean {
  const audit = seg.meta?.segmentPickAudit
