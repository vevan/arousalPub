...
import {
  ...
  toLanceFtsConfig,
} from '../src/lance-hybrid-search.js'
import { formatHybridFtsSpec } from '../src/hybrid-fts-settings.js'
...
describe('hybridScoreKind', () => {
  it('detects RRF vs vector fallback', async () => {
    const { hybridScoreKind } = await import('../src/lance-hybrid-search.js')
