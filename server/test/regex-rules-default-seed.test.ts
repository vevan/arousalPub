...
import { applyRegexRulesToText } from '../src/regex-apply.js'
import {
  buildDefaultRegexRulesDocument,
  DEFAULT_ELLIPSIS_PATTERN,
  DEFAULT_REGEX_SEED_RULE_ID,
} from '../src/regex-rules-default-seed.js'
import { normalizeRegexRulesDocument } from '../src/regex-rules-file.js'
